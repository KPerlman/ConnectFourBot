...
class Game(object):
    ...
    def __init__(self):
        ...
        print("We hope you enojy our game.")
    ...
    def nextMove(self):
        ...
        if player.type == "Human":
            # human-specific servo behavior
            servotest.human_move(move)

        elif player.type == "AI":
            # AI-specific servo behavior
            servotest.computer_move(move)
            IRTest.look_for_piece()
...
class Player(object):
    ...
    def move(self, state):
        ...
        while True:
            user_input = input("Enter a move (by column number 1-7): ").strip()
            ...
            if choice < 0 or choice > 6:
                print("Invalid column: must be between 1 and 7")
                continue
